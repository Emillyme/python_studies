...
def inicio():
    print(' ' * 12, '\033[39mMODO\033[m \033[36mMÉDIO\033[m \033[39mATIVADO!\033[m')
    print('-' * 10, '\033[1;36mBEM-VINDO ao SORTEADOR!\033[m', '-' * 10)
    ...
    while True:
        try:
            ...
            if tempo_decorrido >= 10:
                print('\033[1;34mVocê perdeu muito tempo.\033[m')
                break
